...
| Termination Status Codes | Different Cookies Set | Cookies with HttpOnly | Cookies with Secure | Cookies with SameSite | Strict Cookies | Lax Cookies | None Cookies | Cookies with a Path | Cookies with Non-"/" Path | Min Cookies | Max Cookies | Mean Cookies | Median Cookies |
|--------------------------|-----------------------|------------------------|---------------------|----------------------|----------------|-------------|--------------|--------------------|--------------------------|-------------|-------------|--------------|---------------|
